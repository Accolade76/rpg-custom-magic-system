...
<table>
    ...
    <tr>
        ...
        <td>Fudge: +2 (max: +6 per spell)<br/>D&D: 1d10 </td>
    ...
    <tr>
        ...
        <td>5 creatures/items (repel/attract/connect to). 1 location you know or have an item from per 6 points (teleportation/scrying)</td>
